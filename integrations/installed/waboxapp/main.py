"""Auto-generated integration for Waboxapp."""
...
class IntegrationLogic(BaseIntegrationTemplate):
    """Integration for Waboxapp (api_key)."""

    BASE_URL = "https://api.waboxapp.com"
    ...
    async def handle_webhook(self, request: Any) -> Any:
        return {"status": "ok", "provider": "waboxapp"}
