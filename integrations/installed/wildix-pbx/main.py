...
class IntegrationLogic(BaseIntegrationTemplate):
    def __init__(self):
        ...
        self.base_url = "https://api.wildix-pbx.com" # TODO: Verify URL
    ...
    async def execute_sync_task(self, sync_name: str = "default", *args, **kwargs) -> Any:
        async with self._get_client() as client:
            if False:
                pass
            elif sync_name == "colleagues":
                response = await client.get("/wildix-pbx/colleagues")
    ...
    async def handle_webhook(self, request: Any) -> Any:
        return {"status": "ok", "provider": "wildix-pbx"}
